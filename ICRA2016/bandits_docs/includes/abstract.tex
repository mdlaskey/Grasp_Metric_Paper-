...
Experiments suggest that prior data can speed robust grasp planning by a factor of up to 3 and that average grasp quality increases with the number of similar objects in the dataset.
