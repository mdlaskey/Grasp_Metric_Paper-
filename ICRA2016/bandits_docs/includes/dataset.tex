...
%        {\bf Total} & 13,252 & \\ 
%        \end{tabular}
%        \caption{The seven datasets used in Dex-Net 1.0 with the number of models in the dataset and whether or not the models were laser-scanned. The $^*$ indicates a subset of the original dataset. }
%		\tablabel{datasets}
%\vspace*{-15pt}
%\end{table}
%}
