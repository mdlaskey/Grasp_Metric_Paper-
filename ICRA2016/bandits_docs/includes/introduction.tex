...
We develop a Multi-Armed Bandit (MAB) algorithm with correlated rewards to scale robust planning by learning from a large dataset of parallel-jaw grasps and 3D object models.
...
Experiments on using our algorithm to plan parallel-jaw grasps with high probability of force closure from 250 candidates suggest that orders of magnitude of prior data can reduce the average number of samples needed for X by Y and \TODO{Robustness statement} on a test set of 30 objects.
Experiments on the sensitivity to the fsimilarity metric and number of nearest neighbors used from Dex-Net suggest...\TODO{Add}
\TODO{Something about the number of instances...}
