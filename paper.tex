...
In  this work we consider a setting in which a robot has a fixed computational time budget to select a grasp and thus the fixed budget setting is more appropriate.
