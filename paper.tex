...
The robot may need to plan grasps for these objects without prior knowledge of their shape and pose.
...
Grasp planners that assume an exact measurement of shape and pose may fail, for example wh
