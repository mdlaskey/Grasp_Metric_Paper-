...
The computational cost of the Gittins index method can increase exponentially in time as the discount factor approaches $1$.
...
variance 10 units$^2$. All experiments were run on a machine with OS X with a 2.7 GHz Intel core i7 processor and 16 GB 1600 MHz memory in Matlab 2013b.
