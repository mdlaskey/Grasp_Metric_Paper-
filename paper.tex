...
%Solutions to the MAB problem are well-suited to applications for which it is too expensive to evaluate all possible options and have therefore been applied to the optimal design of clinical trials~\cite{simon1989optimal}, market pricing~\cite{rothschild1974two}, and choosing strategies for games~\cite{st2012online}.
