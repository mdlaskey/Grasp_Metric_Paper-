...
\begin{figure}%
    \centering
     \subfloat{{\includegraphics[width=8.5cm, height=7cm]{matlab_figures/pfc.eps} }}%
...
Recent works have studied the effects of uncertainty in object pose and gripper positioning.%, motivated by part tolerancing from manufacturing and the use of low-cost sensors such as the Kinect.
...
\begin{figure*}[ht!]
\centering
\includegraphics[width = 20cm, height = 20cm]{figures/Slide02.jpg}
