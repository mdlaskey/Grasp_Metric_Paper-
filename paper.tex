...
%We use recent results on a Lipschitz constant for the Ferrari-Canny metric \cite{pokorny2013classical}, and prove a tight probabilistic bound on the change in grasp quality under shape uncertainty.
%We also provide an efficient way to calculate the distributions on the grasp parameters and include a way to update them quickly with new observations.
