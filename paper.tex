...
\todo{Michael: The above statement is true and I want to convey this message, however it might take some work to convey. Jeff: "We only need to estimate $\alpha$ and $\beta$ to determine grasp quality" is not true. determine -> estimate might fix it} 
